// components/RpgBattlePreview.tsx
'use client';
...
export default function RpgBattlePreview() {
  return (
    <div className="rpg-preview w-full">
      ...
      {/* Arena — 3 colunas no desktop, empilhado no mobile */}
      <div className="rpg-arena">
        ...
        <div className="rpg-stat-panel">
          ...
          <div className="rpg-bar-wrap"><div className="rpg-bar-hp" /></div>
          <div className="rpg-stat-val">80/100</div>
 
          <div className="rpg-stat-label">MANA</div>
          <div className="rpg-bar-wrap"><div className="rpg-bar-mp" /></div>
          <div className="rpg-stat-val">8/30</div>
 
          <div className="rpg-stat-label">EXP</div>
          <div className="rpg-bar-wrap"><div className="rpg-bar-xp" /></div>
        ...
        <div className="rpg-center">
          ...
          <div className="rpg-monster-hp-wrap"><div className="rpg-monster-hp" /></div>
        </div>
